...
describe('AddUser', () => {
  ...
  describe('block', () => {
    it('should send correct json response', async () => {
      const req: Request = followersMockRequest({}, authUserPayload, { followerId: '64e3c597ea8e49bb7358d355' }) as Request;
      ...
      expect(blockedUserQueue.addBlockedUserJob).toHaveBeenCalledWith('addBlockedUserToDB', {
        ...
        keyTwo: '64e3c597ea8e49bb7358d355',
        type: 'block'
      });
